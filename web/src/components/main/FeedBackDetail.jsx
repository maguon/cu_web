...
const mapDispatchToProps = (dispatch, ownProps) => ({
    ...
    getFeedBackDetail: () => {
        dispatch(feedBackDetailAction.getFeedBackDetail(ownProps.match.params.id))
    },
    getAfterSaleInfo: () => {
        dispatch(feedBackDetailAction.getFeedBackInfo(ownProps.match.params.id))
    },
    updateFeedBack: () => {
        dispatch(feedBackDetailAction.updateFeedBack(ownProps.match.params.id))
    },
    setDescription: (value) => {
        dispatch(FeedBackDetailActionType.setDescription(value))
    },
    setProcessing: (value) => {
        dispatch(FeedBackDetailActionType.setProcessing(value))
    },
