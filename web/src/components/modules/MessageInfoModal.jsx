                ...
                <div id="messageModal" className="modal modal-fixed-footer row">
                    ...
                    <div className="modal-content white grey-text">
                        ...
                        <div className="row margin-top20 margin-bottom10">
                            <div className="col s6 grey-text fz14">消息编号：{messageDetailReducer.messageInfo[0].id}</div>
                            <div className="col s6 blue-font fz16 bold-font right-align">{sysConst.MESSAGE_TYPE[messageDetailReducer.messageInfo[0].type-1].label}</div>
                        </div>
                        <div className="row divider margin-left10 margin-right10 margin-bottom10"/>

                        {/** 消息时间 */}
                        <div className="row">
                            <div className="col s12 right-align fz14">{formatUtil.getDateTime(messageDetailReducer.messageInfo[0].created_on)}</div>
                        </div>

                        {/** 消息内容 */}
                        <div className="row">
                            <div className="col s-percent-4"><i className="mdi mdi-comment-processing-outline blue-text text-lighten-1 fz20"/></div>
                            <div className="col s-percent-96 word-wrap margin-top3">{messageDetailReducer.messageInfo[0].content}</div>
                        </div>
                    </div>}
